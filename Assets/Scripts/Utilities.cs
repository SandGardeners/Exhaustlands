...
namespace Utilities
{
    public static class Utilities_Transform
    {
        public static T FindComponentInParent<T>(GameObject start) where T : Component
        {
            GameObject go = start.transform.parent.gameObject;
            while(start != null)
            {
